--
-- Script got from: http://forum.geonames.org/gforum/posts/list/2033.page
-- wget http://forum.geonames.org/gforum/posts/downloadAttach/119.page
--
...
LOAD DATA LOCAL INFILE 'data/hierarchy.txt' INTO TABLE hierarchy CHARACTER SET UTF8 (
	parentId,
	childId,
	relationType
);

LOAD DATA LOCAL INFILE 'data/allCountries.txt' INTO TABLE geoname CHARACTER SET UTF8 (
	geonameid,
	name,
	asciiname,
	alternatenames,
...
LOAD DATA LOCAL INFILE 'data/alternateNames.txt' INTO TABLE alternatename CHARACTER SET UTF8 (
	alternatenameid,
	geonameid,
	isoLanguage,
	alternateName,
...
--LOAD DATA LOCAL INFILE 'data/iso-languagecodes.txt' INTO TABLE iso_languagecodes CHARACTER SET UTF8 (
--	iso_639_3,
--	iso_639_2,
--	iso_639_1,
--	language_name
...
INSERT INTO `iso_languagecodes` CHARACTER SET UTF8 (`iso_639_3`, `iso_639_2`, `iso_639_1`, `language_name`) VALUES
('aaa', '', '', 'Ghotuo'),
('aab', '', '', 'Alumu-Tesu'),
('aac', '', '', 'Ari'),
('aad', '', '', 'Amal'),
...
('acn', '', '', 'Achang'),
('acp', '', '', 'Eastern Acipa'),
('acq', '', '', 'Ta''izzi-Adeni Spoken Arabic'),
('acr', '', '', 'Rabinal Achí'),
('acs', '', '', 'Acroá'),
('act', '', '', 'Achterhoeks'),
('acu', '', '', 'Achuar-Shiwiar'),
('acv', '', '', 'Achumawi'),
('acw', '', '', 'Hijazi Spoken Arabic'),
('acx', '', '', 'Omani Spoken Arabic'),
('acy', '', '', 'Cypriot Spoken Arabic'),
('acz', '', '', 'Acheron'),
('ada', 'ada', '', 'Adangme'),
('adb', '', '', 'Adabe'),
('add', '', '', 'Dzodinka'),
('ade', '', '', 'Adele'),
('adf', '', '', 'Dhofari Spoken Arabic'),
('adg', '', '', 'Andegerebinha'),
('adh', '', '', 'Adhola'),
('adi', '', '', 'Adi'),
('adj', '', '', 'Adioukrou'),
...
('ajg', '', '', 'Aja (Benin)'),
('aji', '', '', 'Ajië'),
('ajp', '', '', 'South Levantine Spoken Arabic'),
...
('aoz', '', '', 'Uab Meto'),
('apb', '', '', 'Sa''a'),
('apc', '', '', 'North Levantine Spoken Arabic'),
('apd', '', '', 'Sudanese Spoken Arabic'),
('ape', '', '', 'Bukiyip'),
('apg', '', '', 'Ampanang'),
('aph', '', '', 'Athpariya'),
('api', '', '', 'Apiacá'),
...
('aux', '', '', 'Aurá'),
('auy', '', '', 'Awiyaana'),
('auz', '', '', 'Uzbeki Spoken Arabic'),
('ava', 'ava', 'av', 'Avaric'),
('avb', '', '', 'Avau'),
('avd', '', '', 'Alviri-Vidari'),
('ave', 'ave', 'ae', 'Avestan'),
('avi', '', '', 'Avikam'),
('avl', '', '', 'Eastern Egyptian Bedawi Spoken Arabic'),
('avn', '', '', 'Avatime'),
('avo', '', '', 'Agavotaguerra'),
('avs', '', '', 'Aushiri'),
('avt', '', '', 'Au'),
...
('aye', '', '', 'Ayere'),
('ayg', '', '', 'Ginyanga'),
('ayh', '', '', 'Hadrami Spoken Arabic'),
('ayi', '', '', 'Leyigha'),
('ayk', '', '', 'Akuku'),
('ayl', '', '', 'Libyan Spoken Arabic'),
('aym', 'aym', 'ay', 'Aymara'),
('ayn', '', '', 'Sanaani Spoken Arabic'),
('ayo', '', '', 'Ayoreo'),
('ayp', '', '', 'North Mesopotamian Spoken Arabic'),
...
('dzd', '', '', 'Daza'),
('dzg', '', '', 'Dazaga');
INSERT INTO `iso_languagecodes` (`iso_639_3`, `iso_639_2`, `iso_639_1`, `language_name`) VALUES
('dzl', '', '', 'Dzalakha'),
('dzn', '', '', 'Dzando'),
('dzo', 'dzo', 'dz', 'Dzongkha'),
('ebg', '', '', 'Ebughu'),
...
('eli', '', '', 'Nding'),
('elk', '', '', 'Elkei'),
('ell', 'ell / gre* ', 'el', 'Greek, Modern (1453-)'),
('elm', '', '', 'Eleme'),
('elo', '', '', 'El Molo'),
('elp', '', '', 'Elpaputih'),
('elu', '', '', 'Elu'),
...
('hrt', '', '', 'Hértevin'),
('hru', '', '', 'Hruso'),
('hrv', 'hrv / scr* ', 'hr', 'Croatian'),
('hrz', '', '', 'Harzani'),
('hsb', 'hsb', '', 'Sorbian, Upper'),
...
('lik', '', '', 'Lika'),
('lil', '', '', 'Lillooet'),
('lim', 'lim', 'li', 'Limburgish, Limburger, Limburgan'),
('lin', 'lin', 'ln', 'Lingala'),
('lio', '', '', 'Liki'),
('lip', '', '', 'Sekpele'),
('liq', '', '', 'Libido'),
...
('nwa', '', '', 'Nawathinehena'),
('nwb', '', '', 'Nyabwa'),
('nwc', 'nwc', '', 'Classical Newari; Old Newari'),
('nwe', '', '', 'Ngwe'),
('nwi', '', '', 'Southwest Tanna'),
('nwm', '', '', 'Nyamusa-Molo'),
('nwr', '', '', 'Nawaru'),
...
LOAD DATA LOCAL INFILE 'data/admin1Codes.txt' INTO TABLE admin1Codes CHARACTER SET UTF8 (
	code,
	name
);

LOAD DATA LOCAL INFILE 'data/admin1CodesASCII.txt' INTO TABLE admin1CodesAscii CHARACTER SET UTF8 (
	code,
	name,
	nameAscii,
	geonameid
...
LOAD DATA LOCAL INFILE 'data/featureCodes_en.txt' INTO TABLE featureCodes (
	code,
	name,
	description
);

LOAD DATA LOCAL INFILE 'data/timeZones.txt' INTO TABLE timeZones IGNORE 1 LINES (
	timeZoneId,
	GMT_offset,
	DST_offset,
	raw_offset
...
--LOAD DATA LOCAL INFILE 'data/countryInfo-n.txt' INTO TABLE countryInfo IGNORE 1 LINES CHARACTER SET UTF8 (
--	iso_alpha2,
--	iso_alpha3,
--	iso_numeric,
--	fips_code,
...
LOAD DATA LOCAL INFILE 'data/continentCodes.txt' INTO TABLE continentCodes FIELDS TERMINATED BY ',' (
	code,
	name,
	geonameId
);
