...
# With one Shell:
MY_FIFO=/tmp/my-fifo-allCountries.txt
DATA_FILE=../../zip/allCountries.txt
...
#
SQL_QUERY="set foreign_key_checks=0; set sql_log_bin=0; set unique_checks=0; LOAD DATA LOCAL INFILE '${MY_FIFO}' INTO TABLE zip_codes (iso_alpha2, postal_code, place_name, admin_name1, admin_code1, admin_name2, admin_code2, admin_name3, latitude, longitude, accuracy)"
