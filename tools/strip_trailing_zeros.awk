...
#
# awk -F'^' -f strip_trailing_zeros.awk ../opentraveldata/optd_por_best_known_so_far.csv > ../opentraveldata/optd_por_best_known_so_far.csv
# kdiff3 ../opentraveldata/optd_por_best_known_so_far.csv2 ../opentraveldata/optd_por_best_known_so_far.csv
# \mv -f ../opentraveldata/optd_por_best_known_so_far.csv2 ../opentraveldata/optd_por_best_known_so_far.csv
#
...
#
# Typical OPTD-formatted file of POR
# Sample line:
