...
awk -F'^' -v air_name_alc_diff_file=${OPTD_AIR_ALC_DIFF_FILE} \
	-v air_name_ref_diff_file=${OPTD_AIR_REF_DIFF_FILE} \
	-f ${REDUCER} ${OPTD_AIR_ALC_FILE} ${OPTD_NF_FILE} \
	${OPTD_AIR_FILE} ${OPTD_NOIATA_FILE} ${REF_CAP_FILE} \
...
echo "--------------"
echo
echo "wc -l ${OPTD_AIR_PUBLIC_FILE} ${OPTD_AIR_REF_DIFF_FILE} ${OPTD_AIR_ALC_DIFF_FILE}"
echo
